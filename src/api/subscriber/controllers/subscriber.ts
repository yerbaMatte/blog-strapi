...
`,
        ...
        <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; padding: 20px;">
          ...
          <div style="display: flex; align-items: center; justify-content: center;">
            ...
            <h2 style="flex: 1; margin: 0; color: #2c6e49; font-size: 20px;">Welcome to Code Brew!</h2>
          </div>
          ...
          <p style="font-size: 16px; color: #1e7b3d; font-weight: bold;">
            <a href="${verificationLink}" style="text-decoration: none; color: #1e7b3d;">Click to Verify Your Email</a>
          </p>
